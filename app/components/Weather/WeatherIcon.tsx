    ...
    const icons = {
        Clear: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" stroke="#FFD700" strokeWidth="2" fill="none"/>
            </svg>
        ),
        Clouds: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                <path d="M18 10a6 6 0 0 0-12 0c0 1.5.5 2.9 1.3 4" stroke="#87CEEB" strokeWidth="2" fill="none"/>
        ...
        Rain: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                ...
                <circle cx="16" cy="14" r="3" fill="#E6E6FA"/>
                <circle cx="12" cy="16" r="2" fill="#E6E6FA"/>
                <path d="M8 18l1 3M12 18l1 3M16 18l1 3" stroke="#4682B4" strokeWidth="2"/>
            </svg>
        ),
        Snow: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                ...
                <circle cx="16" cy="14" r="3" fill="#E6E6FA"/>
                <circle cx="12" cy="16" r="2" fill="#E6E6FA"/>
                <path d="M8 18l1 1M12 18l1 1M16 18l1 1" stroke="#FFFFFF" strokeWidth="2"/>
            </svg>
        ),
        Thunderstorm: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
        ...
        Drizzle: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                ...
                <circle cx="16" cy="14" r="3" fill="#E6E6FA"/>
                <circle cx="12" cy="16" r="2" fill="#E6E6FA"/>
                <path d="M8 18l0.5 2M12 18l0.5 2M16 18l0.5 2" stroke="#4682B4" strokeWidth="1"/>
            </svg>
        ),
        Mist: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
        ...
        Tornado: (
            <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M12 8c-1 0-2 0.5-2 1s1 1 2 1 2-0.5 2-1-1-1-2-1z" fill="#8B4513"/>
                <path d="M12 10c-0.5 0-1 0.25-1 0.5s0.5 0.5 1 0.5 1-0.25 1-0.5-0.5-0.5-1-0.5z" fill="#8B4513"/>
            </svg>
        )
    }
